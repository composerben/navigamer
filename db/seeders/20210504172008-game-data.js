...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Games', [
      ...
      { gameName: 'Sekiro: Shadows Die Twice', releaseDate: '2019-03-22', developer: 'FromSoftware', status: 'Have Not Played', imgUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/6/6e/Sekiro_art.jpg/220px-Sekiro_art.jpg', createdAt: new Date(), updatedAt: new Date() },
